<template>
  <nav class="bg-white w-full py-8 px-6 md:px-12 flex justify-between items-center font-helvetica">
    ...
    <div class="hidden md:flex space-x-8 items-center">
      ...
      <router-link to="/" class="text-black text-lg hover:text-soft-black transition-colors duration-300">projects</router-link>
  ...
  <div v-if="isMobileMenuOpen" class="md:hidden bg-white py-4 px-6">
    ...
    <router-link to="/workcomponentnew" class="block text-black text-lg py-2">projects</router-link>
